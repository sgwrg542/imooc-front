<template>
  ...
  >
    ...
    :style="{
      ...
      >
      <!-- :src="data.photo" -->
      <img ref="imgTarget"  v-lazy class="w-full rounded bg-transparent" :src="data.photo" :style="{
      ...
      >
        <m-button @click.stop="onShareClick"  class="absolute top-1.5 left-1.5">分享</m-button>
        <m-button
