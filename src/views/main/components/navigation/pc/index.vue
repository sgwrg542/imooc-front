<template>
  <div class="bg-white sticky top-0 left-0 w-full z-10 duration-500 dark:bg-zinc-800">
    <ul
    ...
    >
      <!-- lg 下展开箭头 -->
      <div
        class="absolute right-1 bottom-1 z-20 p-1 rounded cursor-pointer duration-200 hover:bg-zinc-200 dark:hover:bg-zinc-300"
        @click="triggerState"
      >
        <m-svg-icon
